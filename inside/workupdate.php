...
<br>
  <div class="row">
    <h4 class="col s6 offset-s4">Edit Worker</h4>
  </div>
<div class="row">
  <form class=" offset-s4 col s6" action="workupdate2.php" method="POST">
    <div class="row">
      <input type="hidden" name="id" value="<?= $users[0]['id']?>">
      <div class="input-field col s4">
            <input id="name" type="text" class="validate" name="name" value="<?= $users[0]['name']?>">
            <label for="name">First Name</label>
          </div>
          <div class="input-field col s4">
            <input id="last" type="text" class="validate" name="last" value="<?= $users[0]['last']?>">
    ...
    <div class="row">
      <div class="input-field col s8">
            <input id="age" type="text" class="validate datepicker" name="age" value="<?= $users[0]['age']?>">
            <label for="age">Date of Birth</label>
            </div>
    </div>
    <div class="row">
      <div class="input-field col s8">
            <input id="address" type="text" class="validate" name="address" value="<?= $users[0]['address']?>">
            <label for="address">Address</label>
            </div>
    </div>
    <div class="row">
      <div class="input-field col s8">
            <input id="phone" type="text" class="validate" name="phone" value="<?= $users[0]['phone']?>">
            <label for="phone">Phone Number</label>
            </div>
    </div>
    <div class="row">
      <div class="input-field col s8">
            <input id="email" type="email" class="validate" name="email" value="<?= $users[0]['email']?>">
            <label for="email">E-Mail</label>
            </div>
    </div>
    <div class="row">
      <div class="input-field col s8">
            <input id="employdate" type="text" class="validate datepicker" name="employdate" value="<?= $users[0]['employdate']?>">
