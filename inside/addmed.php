...
<br>
	<div class="row">
		<h4 class="col s6 offset-s4">Add new Medicine</h4>
	</div>
<div class="row">
	<form class=" offset-s4 col s6" action="newmed.php" method="POST">
		<div class="row">
			<input type="hidden" name="ID">
			<div class="input-field col s5">
        	  <input id="medicinename" type="text" class="validate" name="medname">
    ...
    <label>Medicine</label>
		...
		<div class="row">
			<div class="input-field col s8">
        	  <input id="drug" type="text" class="validate" name="drug">
        	  <label for="drug">Generic Name</label>
            </div>
        </div>
		<div class="row">
			<div class="input-field col s4">
        	  <input id="origincountry" type="text" class="validate" name="origincountry">
        	  <label for="origincountry">Country of Origin</label>
            </div>
            <div class="input-field col s4">
            <input id="producer" type="text" class="validate" name="producer">
